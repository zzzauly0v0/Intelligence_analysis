...
This directory holds bilingual (English / Chinese) copies of the project's documentation. The original `.md` files at the repository root and in `backend/` / `frontend/` remain unchanged and stay authoritative in English.

本目录存放项目文档的中英双语版本。仓库根目录及 `backend/`、`frontend/` 下的原始 `.md` 文件保持不变，仍以英文原文为准。
...
| Frontend / 前端 | [en/frontend/README.md](en/frontend/README.md) | [zh/frontend/README.md](zh/frontend/README.md) |
